...
current_dir = os.path.dirname(os.path.abspath(__file__))  # ...\books\tests
parent_dir = os.path.abspath(os.path.join(current_dir, '..'))  # ...\books
...
<body>
    <div class="container-fluid page">
        ...
        """
        self.response = HtmlResponse(url="https://books.toscrape.com",body=self.example_html,encoding="utf-8")

    def test_parse_scrapes_all_items(self):
        """Test if the spider scrapes books and pagination links"""
        # Collect the items produces by the generator in a list
    ...
    def test_parse_creates_pagination_requests(self):
        """Test if the spider creates a pagaination request correctly"""
        results = list(self.spider.parse(self.response))
